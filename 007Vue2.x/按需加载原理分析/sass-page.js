        ...
        var i = {
            ...
            mounted:
                function () {
                    ...
                    var n = this.$broswer.get(); n.indexOf("IE") < 0 &&
            ...
            destroyed: function () {
                document.addEventListener(
                    "DOMMouseScroll", function () { }, !1),
                    document.onmousewheel = function () { }
            },
            computed: {}, methods: {
                scrollFunc: function (e) {
                    e = e || window.event, 1 != this.isPageScrolling && (e.wheelDelta ? (e.wheelDelta > 0 && this.pageCurrentBlockIndex--, e.wheelDelta < 0 && this.pageCurrentBlockIndex++, this.scrollSmoothTo()) : e.detail && (e.detail > 0 && this.pageCurrentBlockIndex--, e.detail < 0 && this.pageCurrentBlockIndex++, this.scrollSmoothTo()))
                },
                scrollSmoothTo: function () {
                    var e = this; this.isPageScrolling = !0; var n = 0; n = this.pageCurrentBlockIndex <= 1 ? 0 : document.documentElement.clientHeight * (this.pageCurrentBlockIndex - 1), this.pageCurrentBlockIndex > 3 && (n = 3 * document.documentElement.clientHeight), window.scrollTo(0, n),
                        setTimeout(function () { e.isPageScrolling = !1 }, 200)
                }
            }
        },
            l = {
